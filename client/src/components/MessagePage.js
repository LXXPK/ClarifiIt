...
const MessagePage = () => {
  ...
  // Function to expand shortcuts into full forms
  ...
  const handleSendMessage = (e) => {
    ...
    if (message.text || message.imageUrl || message.videoUrl) {
      if (socketConnection) {
        const expandedText = expandShortcuts(message.text); // Expand shortcuts before sending
  ...
  return (
    <div style={{ backgroundImage: `url(${backgroundImage})` }} className='bg-no-repeat bg-cover'>
      ...
      <section className='h-16 bg-white flex items-center px-4'>
        ...
        <button onClick={handleVoiceInput} className='flex justify-center items-center w-11 h-11 rounded-full hover:bg-primary hover:text-white'>
